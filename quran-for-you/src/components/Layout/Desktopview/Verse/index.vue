      ...
      <c-flex direction="column" v-bind="mainStyles[colorMode]">
        <c-flex class="container">
          <div v-if="chapter !== undefined">
              ...
              <c-flex w="100%">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <option
                        v-for="(language, index) in Object.keys(
                          state.languages
                        )"
                        :value="language"
                        :key="language + index"
            ...
            <c-flex my="2vw" justify="space-between" align="center">
              <c-image
              ...
              />
              <c-flex>
                <ButtonOutline text="Beginning of  surah" padding="2vw" marginx="1vw"/>
                <ButtonOutline text="Read full chapter" padding="2vw" marginx="1vw"/>
              </c-flex>
              <c-image
        ...
        <c-flex class="container">
          <div v-if="chapter !== undefined">
            ...
            <c-flex direction="column" w="100%">
              ...
              <c-flex my="2.5vw" w="100%">
                <c-flex direction="column" mx="2" w="40%">
                  <c-flex w="100%"
                    ><c-text class="filter-label">Chapters</c-text
                    ><c-icon name="chevron-down" size="1.45vw" color="black"
                  /></c-flex>
...
export default {
  ...
  created() {
    this.$store.dispatch("loadRelatedMedia", [1, 7]);
  },
