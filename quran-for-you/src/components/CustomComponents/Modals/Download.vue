<template>
  ...
  >
    <c-modal-content>
      ...
      <c-modal-body>
        <c-flex direction="column" mb="1vw">
          <c-text>JPEG</c-text>
          <c-divider border-color="gray.500" borderWidth="2px" />
          <c-text>PDF</c-text>
        </c-flex>
        <c-flex mb="2vw">
          ...
          <c-flex direction="column" mx="1" w="25%">
            <c-flex align="center"
              ><c-text class="filter-label">Verse</c-text
        ...
        <c-flex pb="1vw" w="25%" m="auto">
          <CustomButton text="Download" padding="1vw" />
        </c-flex>
      </c-modal-body>
    </c-modal-content>
    <c-modal-overlay />
